...
createTaskBtn.addEventListener('click', () => {
        ...
        div.className = "task-card p-6 bg-gray-100 flex justify-between items-center gap-4 rounded-2xl shadow-xl border border-blue-300"
        div.innerHTML = `
        <input type="checkbox" class="checkbox checkbox-primary" />
        <p class="text-[16px] flex-1"> ${getText}</p>
